...
const ActivityFormContainer = ({
  ...
  return (
    <div className={styles.elementsWidgetsWidget04Parent} style={frameDivStyle}>
      <ElementsWidgetsWidget02
        ...
        elementsWidgetsWidget02Width="333.4px"
        elementsWidgetsWidget02Height="381px"
        elementsWidgetsWidget02Position="relative"
