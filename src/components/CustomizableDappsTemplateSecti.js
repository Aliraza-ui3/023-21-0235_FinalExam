...
import styles from "./CustomizableDappsTemplateSecti.module.css";
...
const CustomizableDappsTemplateSecti = () => {
  return (
    <div className={styles.groupParent}>
      ...
      <div className={styles.buildingBetterWorkParent}>
      ...
      <img className={styles.frameInner} alt="" src="/rectangle-45@2x.png" />
      <ElementsWidgetsWidget01
        ...
        totalSalesLeft="8.58%"
        totalSalesFontSize="16px"
        totalSalesLineHeight="21.86px"
      />
      ...
      <img className={styles.frameChild1} alt="" src="/rectangle-53@2x.png" />
      <img className={styles.frameChild2} alt="" src="/rectangle-54@2x.png" />
